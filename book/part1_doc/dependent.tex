...
val rec mem_correct : ∀a,∀c∈preorder⟨a⟩,∀e e'∈a,∀t∈st⟨a,c.f⟩,
  ...
  fun c e e' t {
    set auto 3 3;
    case t {
      [] → deduce mem c.f e (insert c.f e' t) ≡ is_Eq (c.f e e');
           deduce is_Eq (c.f e e') || mem c.f e t ≡ is_Eq (c.f e e');
           {}
      Node[l, e=e'', r] →
        case c.f e e'' {
        Ls → deduce mem c.f e (insert c.f e' l) ≡ is_Eq (c.f e e') || mem c.f e l
             by mem_correct c e e' l;
             deduce mem c.f e t ≡ mem c.f e l;
             case c.f e' e'' {
               Ls → deduce mem c.f e (insert c.f e' t) ≡ mem c.f e (insert c.f e' l);
                    deduce mem c.f e (insert c.f e' t) ≡ is_Eq (c.f e e') || mem c.f e l;
                    deduce mem c.f e (insert c.f e' t) ≡ is_Eq (c.f e e') || mem c.f e t;
                      {}
               Eq → deduce mem c.f e (insert c.f e' t) ≡ mem c.f e l;
                    deduce c.f e'' e' ≡ Eq by c.sym e' e'';
                    deduce c.f e e' ≡ Ls by c.trans e e' e'';
                    {}
               Gr → deduce mem c.f e (insert c.f e' t) ≡ mem c.f e l;
                    deduce c.f e'' e' ≡ Ls by c.sym e' e'';
                    deduce c.f e e' ≡ Ls by c.trans e e' e'';
                    {}
             }
        Eq → deduce mem c.f e t;
             case c.f e' e'' {
               Ls → deduce mem c.f e (insert c.f e' t);
                    deduce is_Eq (c.f e e') || mem c.f e t;
                    {}
               Eq → deduce mem c.f e (insert c.f e' t);
                    deduce is_Eq (c.f e e') || mem c.f e t;
                    set log "a"; {}
               Gr → deduce mem c.f e (insert c.f e' t);
                    deduce is_Eq (c.f e e') || mem c.f e t;
                    {}
             }
        Gr → deduce mem c.f e (insert c.f e' r) ≡ is_Eq (c.f e e') || mem c.f e r
             by mem_correct c e e' r;
             deduce mem c.f e t ≡ mem c.f e r;
             case c.f e' e'' {
               Gr → deduce mem c.f e (insert c.f e' t) ≡ mem c.f e (insert c.f e' r);
                    deduce mem c.f e (insert c.f e' t) ≡ is_Eq (c.f e e') || mem c.f e r;
                    deduce mem c.f e (insert c.f e' t) ≡ is_Eq (c.f e e') || mem c.f e t;
                    {}
               Eq → deduce mem c.f e (insert c.f e' t) ≡ mem c.f e r;
                    deduce c.f e'' e' ≡ Eq by c.sym e' e'';
                    deduce c.f e e' ≡ Gr by c.trans e e' e'';
                    {}
               Ls → deduce mem c.f e (insert c.f e' t) ≡ mem c.f e r;
                    deduce c.f e'' e' ≡ Gr by c.sym e' e'';
                    deduce c.f e e' ≡ Gr by c.trans e e' e'';
                    {}
             }
      }
