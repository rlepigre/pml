...
one might want to use \dupml{fold_left} for efficiency. This results allows
to do both!

\begin{exercice}\label{exo-list-1}
...
\begin{exercice}\label{exo-list-2}
  Prove some result about the composition of \dupml{map}, \dupml{fold_right}
  and \dupml{fold_left}. This kind of lemmas is useful to avoid building and
  intermediate list.
\end{exercice}
