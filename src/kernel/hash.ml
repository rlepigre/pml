...
let {hash_expr; hash_bndr; hash_ombinder; hash_vwit
  ...
  let rec hash_expr : type a. a ex loc -> int =
    ...
    | Func(t,a,b,l) -> khash4 `Func (E.hash t)
                         (hash_expr a) (hash_expr b) (hash l)
    ...
    | FixM(s,o,b,l) -> khash4 `FixM (hash_sort s) (hash_expr o)
                         (hash_bndr s b) (hash_args l)
    | FixN(s,o,b,l) -> khash4 `FixN (hash_sort s) (hash_expr o)
                         (hash_bndr s b) (hash_args l)
    ...
    | LAbs(_,b,l)   -> khash2 `LAbs (hash_bndr V b) (hash l)
